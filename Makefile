...
COMMON = vector3d.cpp mass.cpp spring.cpp eulercromerintegrator.cpp newmarkintegrator.cpp rk4integrator.cpp cloth.cpp system.cpp util.cpp textrenderer.cpp chaincloth.cpp rectcloth.cpp diskcloth.cpp compositecloth.cpp constraint.cpp hookconstraint.cpp impulsionconstraint.cpp sineimpulsionconstraint.cpp attractionconstraint.cpp
